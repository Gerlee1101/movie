...
export const Footer=()=>{
    return(
        ...
        <div className="flex gap-10 pr-20 ">
            ...
            <div className="flex items-center"><MailIcon/>
            <div className="flex flex-col pl-4"><p>Email:</p>
          <div><p>support@movieZ.com</p>
          </div>
          </div>
          </div>
          <div className="flex items-center pt-5"><PhoneIcon/>
              <div className="flex flex-col pl-4"><p>Phone:</p>
              <div><p>+976 (11) 123-4567</p>
              </div>
             </div>
          </div>
          </div>
            <div className="flex "><PhoneIcon/>
                 <div className="flex flex-col pl-4"><p>Phone:</p>
                 <div className="pt-3"><p>+976 (11) 123-4567</p>
                 </div>
                    </div>
             </div>
